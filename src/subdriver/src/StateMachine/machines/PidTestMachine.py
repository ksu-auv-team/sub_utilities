...
from StateMachine.test_states.spin_forward import *
...
def createStateMachine():
    ...
    with sm_AUV:
        ...
        smach.StateMachine.add('DUMB_START', Dumb_Start(), transitions={'setup_complete':'SPIN_FORWARD'})

        smach.StateMachine.add('SPIN_FORWARD', SpinForward(), transitions={'through_gate':'SURFACE'})
