...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--front-camera', default='/dev/front_camera', help='/path/to/video, defaults to /dev/front_camera')
    parser.add_argument('-b', '--bottom-camera', default='/dev/bottom_camera', help='/path/to/video, defaults to /dev/bottom_camera')
