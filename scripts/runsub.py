...
class SubSession():
    ...
    def start_network(self):
        network_string = "python3 " + self.script_directory + '../submodules/network_wrapper/jetson_live_object_detection.py --model ' + self.network_model_ + ' ' + self.no_save_images_
